...
{\bf Modeling \& improving career trajectories/earning efficiencies of gig workers} \hfill  {\em Fall 2020 - ongoing} \\
{\it Research assistant of the Social AI group, advised by Haiyi Zhu} \hfill { Pittsburgh, PA} \\
{Conducted literature review on practices of gig workers who complete highly specialized tasks} \\
{Modeling freelancing practices using inverse reinforcement learning methods \& data from major gig platforms}
